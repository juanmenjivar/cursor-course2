...
7. Add **Authorized redirect URIs**:
   - Local (Docker): `http://localhost:8000/api/auth/callback/google`
...
| Redirect URI mismatch | Add `http://localhost:8000/api/auth/callback/google` exactly in Google Console |

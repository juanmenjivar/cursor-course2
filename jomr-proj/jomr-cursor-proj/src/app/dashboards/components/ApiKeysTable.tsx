...
export function ApiKeysTable({
  ...
  return (
    <div>
      <p className="mb-2 text-xs text-[#888] sm:hidden">Swipe to see more columns →</p>
      <div className="-mx-4 overflow-x-auto rounded-lg border border-[#333] bg-[#1a1a1a] sm:mx-0">
